"""
Django settings for healthinsuranceusec_45590 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45590.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45590.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45590 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45590 App",
    "VERSION": "v1",
}
